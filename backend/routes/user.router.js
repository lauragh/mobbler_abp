...
const { obtenerUsuarios, crearUsuario, actualizarUsuario, borrarUsuario, actualizarPassword, listaUsuarios, listaUsuariosRol } = require('../controllers/user.controller');
...
router.post('/', [
    ...
    check('grupo', 'El grupo indicado debe ser válido').optional().isMongoId(),
    validarCampos,
    validarRol,
], crearUsuario);
